...
const KitchenOliva = () => {
  ...
  const features = [
    ...
    { icon: 'Trees', title: 'Материалы', text: 'Натуральный дуб, премиум МДФ' },
    { icon: 'Sparkles', title: 'Фартук', text: 'Мрамор с уникальным рисунком' },
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-lg md:text-xl text-gray-700 mb-6 leading-relaxed">
              ...
              Натуральное дерево, мраморный фартук с уникальным узором, премиум-фурнитура 
              и встроенная подсветка создают атмосферу современного комфорта.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <ul className="space-y-2 text-gray-700">
                  <li>• Фасады из массива дуба с натуральной текстурой</li>
                  <li>• Оливковый оттенок нижних шкафов - модный тренд 2024</li>
                  <li>• Белые верхние шкафы визуально расширяют пространство</li>
                  <li>• Мраморный фартук с эффектным природным узором</li>
                  <li>• Матовые фасады устойчивы к отпечаткам</li>
                </ul>
              </div>
        ...
        <Card className="bg-gradient-to-br from-primary/5 to-orange-50 border-primary/20">
          <CardContent className="p-6 md:p-10 text-center">
            ...
            <p className="text-lg text-gray-700 mb-6 max-w-2xl mx-auto">
              При заказе кухни "Олива" дарим набор премиум-органайзеров для всех шкафов 
              и ящиков стоимостью 15 000 ₽
            </p>
            <Button 
              size="lg"
