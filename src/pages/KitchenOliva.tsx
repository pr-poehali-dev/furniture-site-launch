        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-lg md:text-xl text-gray-700 mb-6 leading-relaxed">
              ...
              Пеналы из ЛДСП Egger с текстурой натурального дерева, мраморный фартук с уникальным узором, 
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <ul className="space-y-2 text-gray-700">
                  <li>• Пеналы из ЛДСП Egger премиум-класса с текстурой дерева</li>
                  ...
                  <li>• Матовые фасады устойчивы к отпечаткам и царапинам</li>
                </ul>
              </div>
