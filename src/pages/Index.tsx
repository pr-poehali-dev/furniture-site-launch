  ...
  const products = {
    ...
    bathroom: [
      { 
        ...
        description: 'Современная черная мебель для ванной с интегрированной каменной столешницей. Встроенная подсветка, скрытые ручки, доводчики. Идеальное решение для стиральной зоны.',
