  ...
  const products = {
    ...
    bathroom: [
      { 
        ...
        description: 'Фасады и перегородка для стиральной машины и сушилки из МДФ в пленке. Скрыли коммуникации за техникой — никаких зазоров. Качественные доводчики: плавные и тихие.',
