  ...
  const products = {
    ...
    bathroom: [
      { 
        ...
        description: 'Фасады и перегородка для стиральной машины и сушилки из МДФ в пленке. Коммуникации скрыты за панелью из МДФ в цвет фасадов тумбы. Качественные доводчики: плавные и тихие.',
