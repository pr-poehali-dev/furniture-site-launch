    ...
    wardrobe: [
      { 
        ...
        images: [
          ...
          'https://cdn.poehali.dev/files/5e4ed14e-0468-4f1e-9da6-840116a69755.png',
          'https://cdn.poehali.dev/files/ab7d63c9-2d17-402d-8b0b-4f02c2fadc61.png',
          'https://cdn.poehali.dev/files/d0a28e98-d624-42e6-871a-f238323010ba.png'
        ],
        description: `Вы только посмотрите на этот проект — он будто сошёл со страниц журнала о красивой жизни.

Это не просто шкаф, это буфет для кухни-гостиной, который закрывает нишу и выглядит практически невесомо, хотя и вытянулся от пола до потолка.

- Все благодаря правильной цветовой гамме. И для фасада, и для корпуса мы выбрали нежный оттенок "Кашемир серый". Получилось сдержанно, благородно и со вкусом.

- В центре — бронзовое стекло в алюминиевом профиле Modus. Эффектный акцент, который сразу привлекает взгляд.

- А за ним — интегрированная подсветка, которая вечером создаёт атмосферу премиального бара.

Внутри всё продумано:
- ящики и петли на фурнитуре Hettich с push-to-open,
- удобные полки на разных уровнях,
- глубина корпуса адаптирована под нишу.

Такой шкаф задаёт настроение всей гостиной.`,
